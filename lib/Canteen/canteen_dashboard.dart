...
import 'package:lunchx_order/Canteen/Body/body.dart';
import 'package:lunchx_order/Canteen/menu_manager.dart';
import 'package:lunchx_order/Canteen/order_hostory.dart';
import 'package:lunchx_order/Customer/food_dashboard.dart';
import 'package:lunchx_order/Customer/login.dart';
import 'package:firebase_auth/firebase_auth.dart';
import 'package:cloud_firestore/cloud_firestore.dart';

class YourDrawerCanteen extends StatefulWidget {
  final Function(bool) onShopStatusChanged;
  final bool isShopOpen;

  const YourDrawerCanteen({
    super.key,
  ...
  @override
  _YourDrawerCanteenState createState() => _YourDrawerCanteenState();
}

class _YourDrawerCanteenState extends State<YourDrawerCanteen> {
...
class DashboardCanteen extends StatefulWidget {
  const DashboardCanteen({super.key});

  @override
  _DashboardCanteenState createState() => _DashboardCanteenState();
}

class _DashboardCanteenState extends State<DashboardCanteen> {
